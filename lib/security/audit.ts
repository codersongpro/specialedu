...
export const AUDIT_ACTIONS = {
  ...
  supportNeedCreate: 'support_need.create',
  supportNeedDelete: 'support_need.delete',
  supportAssign: 'support.assign',
  supportUnassign: 'support.unassign',
  supportAvailabilitySave: 'support_availability.save',
  equipmentItemSave: 'equipment_item.save',
  equipmentItemDelete: 'equipment_item.delete',
  equipmentLoanCreate: 'equipment_loan.create',
  equipmentLoanReturn: 'equipment_loan.return',
  equipmentLoanCancel: 'equipment_loan.cancel',
  fieldTripCreate: 'field_trip.create',
  fieldTripUpdate: 'field_trip.update',
  fieldTripDelete: 'field_trip.delete',
  fieldTripChecklistToggle: 'field_trip_checklist.toggle',
  fieldTripChaperoneAssign: 'field_trip_chaperone.assign',
  noticeSave: 'notice.save',
  noticeDelete: 'notice.delete',
  meetingNoteSave: 'meeting_note.save',
  meetingNoteDelete: 'meeting_note.delete',
