 ...
 * 과정별 시정표 — 기본 9교시.
 *
 * 초등 40분, 중등 45분, 고등 50분, 전공과는 100분 블록. 시작 시각이
 * 어긋나 있어 교시 번호로 비교하면 충돌을 놓친다 — 이 데이터가 그걸
 * 실제로 보여준다. 관리자 화면(학교 관리 > 시정표)에서 교시를 자유롭게
 * 추가·삭제·수정할 수 있으니 이건 어디까지나 데모용 출발점이다.
 */
export const PERIODS: Record<string, Array<[number, string, string, string, boolean]>> = {
  elementary: [
    ...
    [6, '6교시', '14:00', '14:40', false],
    [7, '방과후1', '14:50', '15:30', true],
    [8, '방과후2', '15:40', '16:20', true],
    [9, '방과후3', '16:30', '17:10', true],
  ],
  middle: [
    ...
    [8, '방과후2', '16:15', '17:00', true],
    [9, '방과후3', '17:10', '17:55', true],
  ],
  high: [
    ...
    [8, '방과후2', '16:50', '17:40', true],
    [9, '방과후3', '17:50', '18:40', true],
  ],
  vocational: [
...
/** 부서·학급 예산 항목 이름 후보 — 시드가 무작위로 골라 붙인다 */
...
/** 지출 신청 사유 후보 — 부서 이름과 무관하게 그럴듯한 지출 내역이면 됨 */
export const BUDGET_EXPENSE_DESCRIPTIONS = [
  '현장체험학습 버스 대절',
  '촉각 교구 구입',
  '커피·베이킹 실습 재료',
  '행사 다과 구입',
