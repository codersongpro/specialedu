...
const TOOL_LABEL: Record<string, string> = { lesson_adapt: '수준별 수업 변환기', video_kit: '영상 수업 꾸러미' }
...
export default async function PersonalDraftsPage() {
  ...
  return <>
    <PageHeader title="내 수업 초안" description="AI가 만든 검토용 결과만 저장합니다. 원본 입력과 첨부 자료는 저장하지 않습니다." />
